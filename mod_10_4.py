...
#класс Гости потомок класса Thread с методом run
class Guest(Thread):
...
# Список объектов типа Гость
guests = [Guest(name) for name in guests_names]

# Создаём объект Кафе и заполняем столами
cafe = Cafe(*tables)
# Приём гостей
